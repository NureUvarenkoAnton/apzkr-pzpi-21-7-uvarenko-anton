...
func (q *Queries) RatingsByRateeId(ctx context.Context, rateeID sql.NullInt32) ([]Rating, error) {
...
func (q *Queries) RatingsByRaterId(ctx context.Context, raterID sql.NullInt32) ([]Rating, error) {
